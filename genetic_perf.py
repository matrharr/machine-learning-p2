...
from visualization.plot_graphs import plot_genetic_mutation_prob, plot_genetic_pop_size
...
for size in input_sizes:
    ...
    for prob in opt_probs:
        ...
        for opt in options:
            ...
            start = time.time()
            best_state, best_fitness, fitness_curve = genetic(
                problem, mutation_prob=opt
            )
            end = time.time()
...
print(metric_dict)
# plot_genetic_pop_size(metric_dict)
# plot_genetic_mutation_prob(metric_dict)
